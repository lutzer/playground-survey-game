...
const hints : {text: string, img?: string }[] = [
  ...
  { text: 'Wenn du auf ein leeres Feld clickst, kannst du dort etwas bauen.', img: grassIcon},
  { text: 'Wenn du auf ein bebautes Feld klickst, kannst du es entfernen oder zu etwas anderem aendern.', img: emptyIcon},
